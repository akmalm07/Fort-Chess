...
var ASM_CONSTS = {
  201376: () => { if (document.fullscreenElement) return 1; },  
 201422: () => { return Module.canvas.width; },  
 201454: () => { return parseInt(Module.canvas.style.width); },  
 201502: () => { document.exitFullscreen(); },  
 201529: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 201602: () => { if (document.fullscreenElement) return 1; },  
 201648: () => { return Module.canvas.width; },  
 201680: () => { return screen.width; },  
 201705: () => { document.exitFullscreen(); },  
 201732: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 201865: () => { return window.innerWidth; },  
 201891: () => { return window.innerHeight; },  
 201918: () => { if (document.fullscreenElement) return 1; },  
 201964: () => { return Module.canvas.width; },  
 201996: () => { return parseInt(Module.canvas.style.width); },  
 202044: () => { if (document.fullscreenElement) return 1; },  
 202090: () => { return Module.canvas.width; },  
 202122: () => { return screen.width; },  
 202147: () => { return window.innerWidth; },  
 202173: () => { return window.innerHeight; },  
 202200: () => { if (document.fullscreenElement) return 1; },  
 202246: () => { return Module.canvas.width; },  
 202278: () => { return screen.width; },  
 202303: () => { document.exitFullscreen(); },  
 202330: () => { if (document.fullscreenElement) return 1; },  
 202376: () => { return Module.canvas.width; },  
 202408: () => { return parseInt(Module.canvas.style.width); },  
 202456: () => { document.exitFullscreen(); },  
 202483: ($0) => { Module.canvas.style.opacity = $0; },  
 202521: () => { return screen.width; },  
 202546: () => { return screen.height; },  
 202572: () => { return window.screenX; },  
 202599: () => { return window.screenY; },  
 202626: () => { return window.devicePixelRatio; },  
 202662: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 202715: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 202766: () => { Module.canvas.style.cursor = 'none'; },  
 202803: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 203059: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 203110: () => { if (document.pointerLockElement) return 1; },  
 203157: () => { if (document.fullscreenElement) return 1; },  
 203203: () => { return window.innerWidth; },  
 203229: () => { return window.innerHeight; }
};
